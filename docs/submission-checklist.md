...
- [ ] Confirm no `.env`, API key, password, Kaggle token, or personal dataset is included.
- [ ] Upload/send before 12:00 PM IST on 21 August.
- [ ] Rehearse the three-minute script and the answers to the model/fairness questions.
- [ ] Keep a local backup and a cloud backup before submission.
